...
model = AutoModelForCausalLM.from_pretrained("/data-mnt/data/chwang/models/Qwen3-8B").half().cuda().eval()
print("正在加载分词器...")
tokenizer = AutoTokenizer.from_pretrained("/data-mnt/data/chwang/models/Qwen3-8B")
print("模型和分词器加载完成！")
print()
